package com.main.maomorn.tools.roundedimageview;
...
/**
 * Created by MaoMorn on 2017-04-16.
 */
...
public class RoundedImageView extends ImageView {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        int index = typedArray.getInt(R.styleable.RoundedImageView_android_scaleType, 3);
        setScaleType(SCALE_TYPES[index]);

        float cornerRadiusOverride =
                typedArray.getDimensionPixelSize(R.styleable.RoundedImageView_riv_corner_radius, -1);

        mCornerRadii[Corner.TOP_LEFT] =
                typedArray.getDimensionPixelSize(R.styleable.RoundedImageView_riv_corner_radius_top_left, -1);
        mCornerRadii[Corner.TOP_RIGHT] =
                typedArray.getDimensionPixelSize(R.styleable.RoundedImageView_riv_corner_radius_top_right, -1);
        mCornerRadii[Corner.BOTTOM_RIGHT] =
                typedArray.getDimensionPixelSize(R.styleable.RoundedImageView_riv_corner_radius_bottom_right, -1);
        mCornerRadii[Corner.BOTTOM_LEFT] =
                typedArray.getDimensionPixelSize(R.styleable.RoundedImageView_riv_corner_radius_bottom_left, -1);
        ...
        mBorderWidth = typedArray.getDimensionPixelSize(R.styleable.RoundedImageView_riv_border_width, -1);
        if (mBorderWidth < 0) {
            mBorderWidth = DEFAULT_BORDER_WIDTH;
        }

        mBorderColor = typedArray.getColorStateList(R.styleable.RoundedImageView_riv_border_color);
        if (mBorderColor == null) {
            mBorderColor = ColorStateList.valueOf(RoundedDrawable.DEFAULT_BORDER_COLOR);
        }

        mMutateBackground = typedArray.getBoolean(R.styleable.RoundedImageView_riv_mutate_background, false);
        mIsOval = typedArray.getBoolean(R.styleable.RoundedImageView_riv_oval, false);

        final int tileMode = typedArray.getInt(R.styleable.RoundedImageView_riv_tile_mode, TILE_MODE_UNDEFINED);
        ...
        final int tileModeX =
                typedArray.getInt(R.styleable.RoundedImageView_riv_tile_mode_x, TILE_MODE_UNDEFINED);
        if (tileModeX != TILE_MODE_UNDEFINED) {
            setTileModeX(parseTileMode(tileModeX));
        }

        final int tileModeY =
                typedArray.getInt(R.styleable.RoundedImageView_riv_tile_mode_y, TILE_MODE_UNDEFINED);
