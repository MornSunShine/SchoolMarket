...
import com.main.maomorn.adapter.ShopCartAdapter;
import com.main.maomorn.bean.GoodsInfo;
import com.main.maomorn.bean.StoreInfo;
...
/**
 * Created by MaoMorn on 2017-05-14.
 */

public class ShopCartAct extends AppCompatActivity implements ShopCartAdapter.CheckInterface,
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_share:
                ...
                Toast.makeText(ShopCartAct.this, "分享成功", Toast.LENGTH_SHORT).show();
                break;
            case R.id.tv_save:
                if (totalCount == 0) {
                ...
                Toast.makeText(ShopCartAct.this, "保存成功", Toast.LENGTH_SHORT).show();
                break;
        }
    }
